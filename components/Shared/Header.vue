...
import HeaderAgent from './HeaderAgent.vue'
import HeaderTraveller from './HeaderTraveller.vue'
...
export default {
    ...
    methods: {
        showSelected: function(currency) {
...
#currency:active, #currency:focus {
